...
<link href='http://fonts.googleapis.com/css?family=Croissant+One|Lily+Script+One|Donegal+One|Meddon|Quando' rel='stylesheet' type='text/css'>
...
<script>
  ...
  ga('create', 'UA-24426214-8', 'arteastucci.it');
...
<div class="container heading">
  ...
  <div class="logo"> <a href="<?php echo home_url(); ?>"> <img class="a" src="<?php echo get_option('reverb_sitelogo');?>" alt=""> </a>
    ...
    <div class="pull-right header-cart" style="padding-top:0!important">
