...
if(isset($_POST['submitted'])) {
	...
	if(trim($_POST['checking']) !== '') {
		...
		if(trim($_POST['firstname']) === '') {
			$nameError =  __( 'Campo obbligatorio', 'reverb' );;
			$hasError = true;
		} else {
		...
		if(trim($_POST['email']) === '')  {
			$emailError =  __( 'Campo obbligatorio', 'reverb' );
			$hasError = true;
		...
		if(trim($_POST['comments']) === '') {
			$commentError =  __( 'Campo obbligatorio', 'reverb' );
			$hasError = true;
		} else {
    ...
    <form id="contactForm" method="post" class="form-horizontal"  action="<?php the_permalink(); ?>">
      ...
      <div class="row"><div class="span4">
        <div class="control-group">
          <div class="controls">
            <input type="text" name="firstname" id="firstname" placeholder="Nome" class="input-xlarge">
            ...
            <?php     if (!isset($emailError))
{
    $emailError = NULL;
        ...
        <div class="control-group"> 
          ...
          <div class="controls">
            <input type="text" name="phone" id="phone" placeholder="Telefono" class="input-xlarge">
        ...
        <div class="control-group"> 
          ...
          <div class="controls">
            <textarea rows="7" name="comments" id="comments" placeholder="messaggio" class="input-xlarge"></textarea>
            <?php     if (!isset($commentError))
{
    $commentError = NULL;
        ...
        <div class="control-group"> 
          ...
          <!-- Button -->
          <div class="controls">
            <input type="hidden"  name="submitted" id="submit" value="Invia" class="required requiredField" />
            <input type="submit"  class="btn" name="submit" id="submitted" value="Invia" />
          </div>
        </div>
        <br/>
