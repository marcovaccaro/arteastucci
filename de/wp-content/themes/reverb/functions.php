...
function custom_add_to_cart_message() {
	...
	if (get_option('woocommerce_cart_redirect_after_add')=='yes') :
		...
		$message 	= sprintf('<a href="%s" class="btn">%s</a> %s', $return_to, __('Continue Shopping &rarr;', 'woocommerce'), __('Prodotto correttamente aggiunto al carrello.', 'woocommerce') );
 
	else :
 
		$message 	= sprintf('<a href="%s" class="btn">%s</a> %s', get_permalink(woocommerce_get_page_id('cart')), __('View Cart &rarr;', 'woocommerce'), __('Prodotto correttamente aggiunto al carrello.', 'woocommerce') );
