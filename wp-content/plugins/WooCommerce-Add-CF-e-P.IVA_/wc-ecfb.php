<?php
/**
 * Plugin URI: http://www.netstarsolution.net/aggiungere-cf-e-pi-wc/
 * Plugin Name: WooCommerce Aggiungere CF e P.IVA
 * Description: Con questo plugin si può aggiungere il campo Codice Fiscale & Partita Iva necessario per i negozi italiani.. e non solo..
 * Author: Netstarsolution
 * Author URI: http://www.netstarsolution.net
 * Version: 1.1
 * License: GPLv2
 * Text Domain: wcbcf
